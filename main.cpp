...
CANSerialBridge can_sb(&dev0_can);

MDCClient mdc_client(&can_sb, 0);
MDCClient mdc_client_2(&can_sb, 1);
...
inline void toggleAcknowledge() { acknowledge_0 = !acknowledge_0; }
...
int main() {
  ...
  setting_struct_t mdc_settings[8] = {
      //  Azure 0 -> no.0
      {OperatorMode::MD_OPERATOR, EncoderType::VELOCITY, ENCODER_REVOLUTION,
       false, 1.7, 0, 0, 0, 0, 0, 0},
      //  Azure 0 -> no.1
      {OperatorMode::MD_OPERATOR, EncoderType::VELOCITY, ENCODER_REVOLUTION,
       false, 1.9, 0, 0, 0, 0, 0, 0},
      //  Azure 0 -> no.2
      {OperatorMode::MD_OPERATOR, EncoderType::VELOCITY, ENCODER_REVOLUTION,
       false, 1.8, 0, 0, 0, 0, 0, 0},
      //  Azure 0 -> no.3
      {OperatorMode::MD_OPERATOR, EncoderType::VELOCITY, ENCODER_REVOLUTION,
       false, 1.9, 0, 0, 0, 0, 0, 0},
      //////////////////
